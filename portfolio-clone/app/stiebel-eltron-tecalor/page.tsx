        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="content-animation">
            <AnimateIn animation="fade-up" duration="normal" delay={100}>
              <h1 className="text-4xl sm:text-5xl font-medium mb-12">OVO Group design system</h1>
            </AnimateIn>
            ...
            <AnimateIn animation="fade-up" duration="normal" delay={200}>
              <div ref={heroRef} className="aspect-[16/9] relative rounded-2xl overflow-hidden bg-[#1B4D5C]">
                <Image
                  ...
                  alt="OVO Group design system preview"
                  fill
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <p className="text-gray-400">
                        Led the development and implementation of OVO Group's design system, creating a unified visual
                        language and component library that streamlined the development process across multiple products
                        and teams.
                      </p>
                      <p className="text-gray-400">
            ...
            <AnimateIn animation="fade-up" duration="normal" delay={400}>
              <div className="mt-24 space-y-12 max-w-[1000px]">
                <div>
                  ...
                  <p className="text-gray-400">
                    OVO Group faced challenges maintaining consistency across their growing product portfolio. Different
                    teams were creating similar components with varying styles, leading to inconsistent user experiences
